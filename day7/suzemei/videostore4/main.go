...
func main() {
	...
	movie1 := movie.ReMovie{Title: "Star Wars", PriceCode: movie.REGULAR}
	rental1.Init(movie1,3)
	aCustomer.AddRental(rental1)

	var rental2 rental.Rental
	movie2 := movie.Ne_Movie{Title: "The Godfather Part II", PriceCode: movie.NEW_RELEASE}
	rental2.Init(movie2, 1)
	aCustomer.AddRental(rental2)

	var rental3 rental.Rental
	movie3 := movie.ChMovie{Title: "Casablanca", PriceCode: movie.CHILDRES}
